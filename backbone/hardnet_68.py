...
class DWConvLayer(nn.Sequential):
    ...
    def __init__(self, in_channels, out_channels, stride=1, bias=False):
        ...
        self.add_module('dwconv', nn.Conv2d(groups, groups, kernel_size=(3, 3),
                                            stride=(stride, stride), padding=1, groups=groups, bias=bias))
...
class ConvLayer(nn.Sequential):
    ...
    def __init__(self, in_channels, out_channels, kernel=3, stride=1, bias=False):
        ...
        out_ch = out_channels
        groups = 1
        self.add_module('conv', nn.Conv2d(in_channels, out_ch, kernel_size=(kernel, kernel),
                                          stride=(stride, stride), padding=kernel // 2, groups=groups, bias=bias))
