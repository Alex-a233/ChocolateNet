...
class ReverseAttention(nn.Module):
    ...
    def __init__(self, in_channel, out_channel, depth=3, kernel_size=3, padding=1):
        ...
        self.conv_out = MyConv(out_channel, 1, kernel_size, padding=padding, is_act=False)
...
class BoundaryAttention(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv3 = MyConv(64, 64, 1)
        self.conv2 = MyConv(64, 64, 1)
        self.conv4 = MyConv(64, 64, 1)
...
class SpatialAttention(nn.Module):
    ...
    def __init__(self, kernel_size=7):
        ...
        self.conv = MyConv(2, 1, kernel_size, padding=padding, is_bn=False)
